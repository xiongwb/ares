...
class HeatingCost extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
            disabled: true,
    ...
    selectFamily() {
        if (this.props.family) {
            return this.props.navigator.push({ id: 'HeatingFamily', params: { family: this.props.family } })
        } else {
            return this.props.navigator.push({ id: 'HeatingFamily', params: { family: '我家' } })
        }
    ...
    submit() {
        ...
        this.props.navigator.push({ id: 'HeatingConfirm', params: { code: this.state.code, org: this.state.org } })
    }
