...
class Type2Recharge extends BasePage  {
   constructor (props) {
    super(props);
    this.state = {
  ...
  onRight_ButtonClick(){
    this.refs.dialog.close()
        AresAPI.TranAcctSelf.tranAcctSelf1To2({
  ...
  return(
       <View style={styles.root}>
        <BackNavBar component={this}>充值</BackNavBar>
          ...
          <Text style={{ fontSize:12,color:'#D3D3D3'}}>银行卡转入到Ⅱ类账户</Text>
          </View>
...
export default createForm()(Type2Recharge)
