      ...
      <View style={styles.body_body}>
        <View style={styles.body_head}>
          <View style={{flex:1,alignItems:'center'}}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('佳木斯')}}>
              <Text>
                佳木斯
              </Text>
            </TouchableOpacity>
          ...
          <View style={styles.body_in}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('哈尔滨')}}>
              <Text>
                哈尔滨
              </Text>
            </TouchableOpacity>
          ...
          <View style={{flex:1,alignItems:'center'}}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('北京')}}>
              <Text>
                北京
              </Text>
            </TouchableOpacity>
        ...
        <View style={styles.body_head}>
          <View style={{flex:1,alignItems:'center'}}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('天津')}}>
              <Text>
                天津
              </Text>
            </TouchableOpacity>
          ...
          <View style={styles.body_in}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('深圳')}}>
              <Text>
                深圳
              </Text>
            </TouchableOpacity>
          ...
          <View style={{flex:1,alignItems:'center'}}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('重庆')}}>
              <Text>
                重庆
              </Text>
            </TouchableOpacity>
        ...
        <View style={{flexDirection:'row',flex:1,alignItems:'center'}}>
          <View style={{flex:1,alignItems:'center'}}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('鹤岗')}}>
              <Text>
                鹤岗
              </Text>
            </TouchableOpacity>
          ...
          <View style={styles.body_in}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('双鸭山')}}>
              <Text>
                双鸭山
              </Text>
            </TouchableOpacity>
          ...
          <View style={{flex:1,alignItems:'center'}}>
            <TouchableOpacity onPress = {() => {that.selectedLocation('漠河')}}>
              <Text>
                漠河
              </Text>
            </TouchableOpacity>
