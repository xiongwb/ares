...
class TelephoneCost extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
            disabled: true,
    ...
    selectFamily() {
        if (this.props.family) {
            return this.props.navigator.push({ id: 'TelephoneFamily', params: { family: this.props.family } })
        } else {
            return this.props.navigator.push({ id: 'TelephoneFamily', params: { family: '我家' } })
        }
    ...
    submit() {
      ...
      if (regexp.test(this.state.code) === false) {
        ...
        this.props.navigator.push({ id: 'TelephoneConfirm', params: { code: this.state.code, org: this.state.org } })
    }
            ...
            <View style={styles.root}>
                ...
                <View style={styles.familyView}>
                    <View style={styles.iconView}>
                        <Image source={require('../assets/image/phone_broadband.png')} />
                        <Text style={styles.iconText}>固话宽带</Text>
                    </View>
                ...
                <View style={styles.userCode}>
                    ...
                    <View style={styles.userView}>
                        ...
                        <TextInput style={{ flex: 1 }} maxLength={8} keyboardType="numeric" placeholder='查看纸质账单' placeholderTextColor='#CCCCCC' underlineColorAndroid='transparent' value={this.state.code} onChangeText={value => this.inputChange(value)}/>
                    </View>
                </View>
