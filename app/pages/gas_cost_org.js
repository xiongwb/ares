...
class GasCostOrg extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchData() {
        let data = [{ id: 1, name: "津燃华润（居民用户）" }, { id: 2, name: "津燃华润（商业用户）" }, { id: 3, name: "天津泰达燃气有限责任公司" }];
        return data;
    }

    onChange(org) {
        this.setState({ id: org.id });
        this.props.navigator.push({ id: "GasCost", params: { org: org } })
    }
