...
class HeatingCostOrg extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchData() {
        let data = [{ id: 1, name: "天津市城安热电有限公司" }, { id: 2, name: "天津市津安热电有限公司" }, { id: 3, name: "天津市津能滨海热电有限公司" }, { id: 4, name: "天津市热电有限公司" }, { id: 5, name: "天津市热力有限公司" }];
        return data;
    }

    onChange(org) {
        this.setState({ id: org.id });
        this.props.navigator.push({ id: "HeatingCost", params: { org: org } })
    }
