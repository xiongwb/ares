...
class ElectricityFamily extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
    ...
    onChange(family) {
        ...
        NavigatorUtils.popToRoute(this.props.navigator, { id: 'ElectricityCost', params: { family: family} })
    }
...
export default ElectricityFamily
