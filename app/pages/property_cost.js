...
class PropertyCost extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
            disabled: true,
    ...
    selectFamily() {
        if (this.props.family) {
            return this.props.navigator.push({ id: 'PropertyFamily', params: { family: this.props.family } })
        } else {
            return this.props.navigator.push({ id: 'PropertyFamily', params: { family: '我家' } })
        }
    ...
    submit() {
      ...
      if (regexp.test(this.state.code) === false) {
        ...
        this.props.navigator.push({ id: 'PropertyConfirm', params: { code: this.state.code, org: this.state.org } })
    }
            ...
            <View style={styles.root}>
                ...
                <View style={styles.familyView}>
                    <View style={styles.iconView}>
                        <Image source={require('../assets/image/Property.png')} />
