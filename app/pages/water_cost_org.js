...
class WaterCostOrg extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchData() {
        let data = [{ id: 1, name: "静海水务有限公司" }, { id: 2, name: "天津泰达津联自来水有限公司" }];
        return data;
    }

    onChange(org) {
        this.setState({ id: org.id });
        this.props.navigator.push({ id: "WaterCost", params: { org: org } })
    }
            ...
            <View style={styles.root}>
                ...
                <View style={styles.searchView}>
                    <View style={styles.inputView}>
                        <TextInput placeholder="目前无搜索引擎，暂不支持搜索" editable={false} underlineColorAndroid='transparent' value={this.state.text} onChangeText={value => this.setState({ text: value })} />
                    </View>
                </View>
                <List>
                    {datas.map(i => (
