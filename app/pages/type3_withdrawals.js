...
class Type3Withdrawals extends BasePage  {
   constructor (props) {
    super(props);
    this.state = {
       ...
       <View style={styles.root}>
        <BackNavBar component={this}>提现</BackNavBar>
         <View style={{alignItems:'center',marginTop:12}} >
          <Text style={{ fontSize:12,color:'#D3D3D3'}}>Ⅲ转入到银行卡类账户</Text>
          </View>
          <View style={{marginTop:12,marginBottom:33}}>
            ...
            <AresTextInput maxLength={11} borderWidth={0.5} title="金额" onChangeText={this.on_change.bind(this)} />
...
export default createForm()(Type3Withdrawals)
