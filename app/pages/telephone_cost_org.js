...
class TelephoneCostOrg extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchData() {
        let data = [{ id: 1, name: "（固话）中国电信集团" }, { id: 2, name: "（宽带）中国电信集团" }, { id: 3, name: "（固话）中国电信股份有限公司" }, { id: 4, name: "（宽带）中国电信股份有限公司" }];
        return data;
    }

    onChange(org) {
        this.setState({ id: org.id });
        this.props.navigator.push({ id: "TelephoneCost", params: { org: org } })
    }
...
export default TelephoneCostOrg
