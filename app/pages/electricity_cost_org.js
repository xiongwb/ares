...
class ElectricityCostOrg extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchData() {
        let data = [{ id: 1, name: "国网天津市电力公司" }];
        return data;
    }

    onChange(org) {
        this.setState({ id: org.id });
        this.props.navigator.push({ id: "ElectricityCost", params: { org: org } })
    }
...
export default ElectricityCostOrg
