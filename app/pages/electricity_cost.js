...
class ElectricityCost extends BasePage {
    constructor(props) {
        super(props);
        this.state = {
            disabled: true,
    ...
    selectFamily() {
        if (this.props.family) {
            return this.props.navigator.push({ id: 'ElectricityFamily', params: { family: this.props.family } })
        } else {
            return this.props.navigator.push({ id: 'ElectricityFamily', params: { family: '我家' } })
        }
    ...
    submit() {
        ...
        this.props.navigator.push({ id: 'ElectricityConfirm', params: { code: this.state.code, org: this.state.org } })
    }
            ...
            <View style={styles.root}>
                ...
                <View style={styles.familyView}>
                    <View style={styles.iconView}>
                        <Image source={require('../assets/image/power_rate.png')} />
                        <Text style={styles.iconText}>电费</Text>
                    </View>
                ...
                <View style={styles.userCode}>
                    ...
                    <View style={styles.userView}>
                        ...
                        <TextInput style={{ flex: 1 }} keyboardType="numeric" maxLength={8} placeholder='查看纸质账单' placeholderTextColor='#CCCCCC' underlineColorAndroid='transparent' value={this.state.code} onChangeText={value => this.inputChange(value)}/>
                    </View>
                </View>
