...
public class SegmentControlView extends View {
    ...
    private static final int COLOR_PRIMARY_SELECTED = 0xfff5787c;
    ...
    private SegmentControlView.OnSegmentChangedListener mOnSegmentChangedListener;
...
//    		invalidate();
    ...
    public void setmFrameCornerRadius(int radius){
        this.mFrameCornerRadius = radius;
        requestLayout();
        invalidate();
    }
     ...
     */
    public void setOnSegmentChangedListener(SegmentControlView.OnSegmentChangedListener listener){
